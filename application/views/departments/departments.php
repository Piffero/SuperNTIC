...
<div class="container-fluid" id="pcont">
	...
	<div class="cl-mcont">
			...
			<div class="col-sm-5">
				<div class="btn-group">
					<a class="btn btn-primary btn-flat" type="button"
						href="<?php echo $this->config->site_url('departments/append');?>"><i
			...
			<div class="col-sm-4 input-group text-right">
				<form
					action="<?php echo $this->config->site_url('departments/search')?>"
					method="post">
					<input class="form-control" type="text"
						placeholder="Busca de Departamentos:" autocomplete="off"
...
<script>
	...
	function mudaCor(id_da_linha){
		document.getElementById('edit').setAttribute("href","<?php echo $this->config->site_url('departments/view');?>/"+id_da_linha);
		document.getElementById('delete').setAttribute("href","<?php echo $this->config->site_url('departments/delete');?>/"+id_da_linha); 		
		}

	function D(id) {
        window.location.href = "<?php echo $this->config->site_url('departments/view');?>/"+id;                 
   }
</script>
