...
<div class="container-fluid" id="pcont">
	...
	<div class="cl-mcont">
			...
			<div class="col-sm-5">
				<div class="btn-group">
					<a class="btn btn-primary btn-flat" type="button"
						href="<?php echo $this->config->site_url('employees/append');?>"><i
			...
			<div class="col-sm-4 input-group text-right">
				...
				<form
					action="<?php echo $this->config->site_url('employees/search')?>"
					method="post">
					<input class="form-control" type="text"
						placeholder="Busca de Funcionários:" autocomplete="off"
				...
				<div class="tab-container">
					...
					<ul class="nav nav-tabs">
						<li class="active"><a href="#list" data-toggle="tab"><i
								class="fa fa-align-justify"></i> Lista de Funcion&#225;rios</a></li>
					</ul>
					<!------CONTROL TABS END------->
...
<script>
	...
	{
		document.getElementById('edit').setAttribute("href","<?php echo $this->config->site_url('employees/view');?>/"+id_da_linha);
		document.getElementById('delete').setAttribute("href","<?php echo $this->config->site_url('employees/delete');?>/"+id_da_linha); 		
	}

	function D(id) {
        window.location.href = "<?php echo $this->config->site_url('employees/view');?>/"+id;                 
   }
</script>
