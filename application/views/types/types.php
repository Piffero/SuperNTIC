...
<div class="container-fluid" id="pcont">
	<div class="page-head">
		<h2>Registro de Tipo de Produtos</h2>
	</div>
	<div class="cl-mcont">
			...
			<div class="col-sm-5">
				<div class="btn-group">
					<a class="btn btn-primary btn-flat" type="button"
						href="<?php echo $this->config->site_url('types/append');?>"><i
			...
			<div class="col-sm-4 input-group text-right">
				<form action="<?php echo $this->config->site_url('types/search')?>"
					method="post">
					<input class="form-control" type="text"
						placeholder="Busca de Tipos de Produto:" autocomplete="off"
						autofocus="autofocus" id="search" name="search">
				</form>
			</div>
				...
				<div class="tab-container">
					...
					<ul class="nav nav-tabs">
						<li class="active"><a href="#list" data-toggle="tab"><i
								class="fa fa-align-justify"></i> Lista de Tipos de Produtos</a></li>
					</ul>
					<!------CONTROL TABS END------->
...
<script>
	...
	function mudaCor(id_da_linha){
		document.getElementById('edit').setAttribute("href","<?php echo $this->config->site_url('types/view');?>/"+id_da_linha);
		document.getElementById('delete').setAttribute("href","<?php echo $this->config->site_url('types/delete');?>/"+id_da_linha); 		
		}

	function D(id) {
        window.location.href = "<?php echo $this->config->site_url('types/view');?>/"+id;                 
   }
</script>
