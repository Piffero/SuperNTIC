...
<div class="container-fluid" id="pcont">
	...
	<div class="cl-mcont">
			...
			<div class="col-sm-5">
				<div class="btn-group">
					<a class="btn btn-primary btn-flat" type="button"
						href="<?php echo $this->config->site_url('planaccounts/append');?>"><i
			...
			<div class="col-sm-4 input-group text-right">				
					...
					<?php echo form_open('planaccounts/search');?>						
						<input class="form-control" type="text"
					placeholder="Busca de Planos de Conta:" autocomplete="off"
				...
				<div class="tab-container">
					...
					<ul class="nav nav-tabs">
						<li class="active"><a href="#list" data-toggle="tab"><i
								class="fa fa-align-justify"></i> Lista de Plano de Contas</a></li>
					</ul>
					<!------CONTROL TABS END------->
...
<script>
	...
	function mudaCor(id_da_linha){
		document.getElementById('edit').setAttribute("href","<?php echo $this->config->site_url('planaccounts/view');?>/"+id_da_linha);
		document.getElementById('delete').setAttribute("href","<?php echo $this->config->site_url('planaccounts/delete');?>/"+id_da_linha); 		
		}

	function D(id) {        
        window.location.href = "<?php echo $this->config->site_url('planaccounts/view');?>/"+id;                
   }
</script>
