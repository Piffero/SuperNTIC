...
$dadosboleto["nosso_numero_const2"] = "2"; // constanto 2 , 4=emitido pelo proprio cliente
$dadosboleto["nosso_numero3"] = $nossonum; // "000000019"; // tamanho 9
...
$dadosboleto["agencia"] = $agencia; // "1234"; // Num da agencia, sem digito
$dadosboleto["conta"] = ""; // 123"; // Num da conta, sem digito
$dadosboleto["conta_dv"] = $digito_conta; // "0"; // Digito do Num da conta
                                           
// DADOS PERSONALIZADOS - CEF
$dadosboleto["conta_cedente"] = $conta; // "123456"; // C�digo Cedente do Cliente, com 6 digitos (Somente N�meros)
