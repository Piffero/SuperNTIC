...
$dadosboleto["nosso_numero"] = $nossonum; // '12345678'; // Nosso numero - REGRA: M�ximo de 8 caracteres!
$dadosboleto["numero_documento"] = $ndocum; // '0123'; // Num do pedido ou nosso numero
...
$dadosboleto["demonstrativo1"] = $description; // '';//"Pagamento de Compra na Loja Nonononono";
...
$dadosboleto["carteira"] = $carteira; // "175"; // C�digo da Carteira: pode ser 175, 174, 104, 109, 178, ou 157
