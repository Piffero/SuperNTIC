...
$valor_cobrado = str_replace(",", ".", $docvalue);
$valor_boleto = number_format($valor_cobrado + $taxa_boleto, 2, ',', '');

$dadosboleto["nosso_numero"] = $nossonum; // "1234567"; // Nosso numero sem o DV - REGRA: M�ximo de 7 caracteres!
$dadosboleto["numero_documento"] = $ndocum; // "12345"; // Num do pedido ou nosso numero
...
$dadosboleto["codigo_cliente"] = str_pad($patient_id, 7, "0", STR_PAD_LEFT); // "0707077"; // Código do Cliente (PSK) (Somente 7 digitos)
$dadosboleto["ponto_venda"] = $agencia; // "1333"; // Ponto de Venda = Agencia
$dadosboleto["carteira"] = $carteira; // "102"; // Cobran�a Simples - SEM Registro
