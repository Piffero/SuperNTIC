...
do Sacado</b></div></td></tr></tbody></table>
		...
		<tbody>
		<tr>
			<td width=150><img src="<?php echo $this->config->base_url();?>application/views/boletos/boletos/imagens/logobb.jpg"></td>
			<td width=50>
    ...
    <table cellspacing="0" cellpadding="0" width="666" border="0"><tbody><tr><td width="666" align="right"><span style="font-size: 10px;">Autentica&ccedil;&atilde;o mec&acirc;nica - Ficha de Compensação</span></td></tr></tbody></table>
		<div class="barcode">
