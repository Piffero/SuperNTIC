...
//Guarda inicial
?>
<img src="../../application/views/boletos/boletos/imagens/p.png" width="<?php echo $fino?>" height="<?php echo $altura?>" border="0">
<img src="../../application/views/boletos/boletos/imagens/b.png" width="<?php echo $fino?>" height="<?php echo $altura?>" border="0">
<img src="../../application/views/boletos/boletos/imagens/p.png" width="<?php echo $fino?>" height="<?php echo $altura?>" border="0">
<img src="../../application/views/boletos/boletos/imagens/b.png" width="<?php echo $fino?>" height="<?php echo $altura?>" border="0">
<img 
<?php
...
// Draw guarda final
?>
src="../../application/views/boletos/boletos/imagens/p.png" width="<?php echo $largo?>" height="<?php echo $altura?>" border="0">
<img src="../../application/views/boletos/boletos/imagens/b.png" width="<?php echo $fino?>" height="<?php echo $altura?>" border="0">
<img src="../../application/views/boletos/boletos/imagens/p.png" width="<?php echo 1?>" height="<?php echo $altura?>" border="0"> 
  <?php
} //Fim da função
