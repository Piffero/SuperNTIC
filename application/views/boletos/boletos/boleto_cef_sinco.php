...
$dadosboleto["nosso_numero"] = $nossonum; // "19525086"; // Nosso numero sem o DV - REGRA: M�ximo de 16 caracteres! (Pode ser um n�mero sequencial do sistema, o cpf ou o cnpj)
...
$dadosboleto["conta_cedente"] = $conta; // "057335"; // ContaCedente do Cliente, sem digito (Somente N�meros)
$dadosboleto["conta_cedente_dv"] = $digito_conta; // ""; // Digito da ContaCedente do Cliente
