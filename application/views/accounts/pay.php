	...
	<div class="colored-header danger" id="form-primary"
		...
		<div class="md-content">
			<div class="modal-header">
				<h3>Lan&#231;amento Conta a Pagar</h3>
			...
			<div class="modal-body form">
                       <?php if(isset($manage_result)){echo $manage_result;}else{echo '';}; ?>
                        ...
                        echo form_open('accounts/save/1', array(
                            'id' => 'accounts_form',
				...
				<div class="form-group col-sm-12">
					<div class="col-sm-6">
						<label class="control-label">Fornecedor</label>
						        	<?php echo form_dropdown('favored',$supplier_info, array($accounts_info->favored), 'class="select2"');?>
						       </div>
					<div class="col-sm-6">
