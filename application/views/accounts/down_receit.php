...
<div class="container-fluid" id="pcont" style="background-color: white;">
				...
				<div class="mail-nav collapse">
					<ul class="nav nav-pills nav-stacked">
						<li><a href="<?php echo $this->config->site_url('accounts');?>"><span
								class="label label-success pull-right"><?php if(isset($sum_accont_rend['sum'])){echo $sum_accont_rend['sum'];}else{echo '0,00';}?></span><i
								class="fa fa-arrow-left text-success"></i> Contas a Receber</a></li>
						<li><a
							href="<?php echo $this->config->site_url('accounts/payables');?>"><span
								class="label label-danger pull-right"><?php if(isset($sum_accont_pay['sum'])){echo $sum_accont_pay['sum'];}else{echo '0,00';}?></span><i
	...
	<div class="container-fluid" id="pcont">
		<div class="message">
			<div class="head">
				<h3 class="page-title">Receitas Consolidadas</h3>
			</div>
			<div class="mail" style="width: 870px; height: 510px;">
      <?php date_default_timezone_set('America/Sao_Paulo'); ?>
       		<div class="col-md-12">
					<div class="content">
							<?php echo form_open('accounts/donw_receit',array('id'=>'filter_form'));?>
								<div class="col-sm-2">
							...
							<table class="table no-border hover">
								...
								<tfoot class="no-border-y">
									<tr>
										...
										<td colspan="3" class="text-center color-success">R$ <?php if(isset($sum_rend)){echo get_float_view($sum_rend);}else{echo '0,00';}?></td>
									</tr>
								</tfoot>
							</table>
						</div>
