...
<div class="container-fluid" id="pcont" style="background-color: white;">
	...
	<div class="container-fluid" id="pcont">
      ...
      <?php date_default_timezone_set('America/Sao_Paulo'); ?>
        <div class="col-md-12">
					<div class="content">
				<?php echo form_open('accounts/payables',array('id'=>'filter_form'));?>
					<div class="col-sm-2">
				...
				<p align="right">
							<button class="btn btn-default btn-flat"
								onClick="javascript:window.open('<?php echo $this->config->site_url('accounts/append/1');?>','Lancamento Contas','STATUS=NO, TOOLBAR=NO, LOCATION=NO, DIRECTORIES=NO, RESISABLE=NO, SCROLLBARS=YES, TOP=50, LEFT=70,width=770,height=500');"
							...
							<a id="delete" class="btn btn-default btn-flat"
					...
					<tfoot class="no-border-y">
									<tr>
										...
										<td colspan="2" class="text-center color-danger">R$ <?php if(isset($sum_accont_pay)){echo get_float_view($sum_accont_pay);}else{echo '0,00';}?></td>
									</tr>
								</tfoot>
							</table>
						</div>
	...
	<!-- Nifty Modal -->
	<div class="md-modal colored-header danger custom-width md-effect-9"
		...
		<div class="md-content">
			...
			<div class="modal-body form">
				...
				<div class="row no-margin-y">
					<div class="form-group col-md-4 col-sm-4  col-xs-4 no-margin">
						<input id="set_data" type="text" class="form-control"
			...
			<div class="modal-footer">
				...
				<button id="btn_down" type="button" class="btn btn-danger btn-flat"
...
<script> 		
	...
	function D(id) {  
		window.open("<?php echo $this->config->site_url('accounts/append/1');?>/"+id,"Lancamento Contas","STATUS=NO, TOOLBAR=NO, LOCATION=NO, DIRECTORIES=NO, RESISABLE=NO, SCROLLBARS=YES, TOP=50, LEFT=70,width=770,height=500");                        
   }
