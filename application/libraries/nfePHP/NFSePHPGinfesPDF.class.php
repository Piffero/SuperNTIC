...
class NFSePHPGinfesPDF extends FPDF
{
    ...
    public function Header()
    {
        ...
        $this->Cell(3.4, 0.6, $doc->getElementsByTagName("CodigoVerificacao")
            ->item(0)->nodeValue, 1, 1, "C");
        
        // LINHA 2
        $this->SetXY(0.5, 3.7);
        $this->Cell(3.2, 0.6, "Nùmero RPS", 1, 0, "C", 1);
        $this->Cell(3.2, 0.6, $doc->getElementsByTagName("Numero")
            ->item(1)->nodeValue, 1, 0, "C");
        ...
        $this->Cell(14.2, 0.5, $doc->getElementsByTagName("RazaoSocial")
            ->item(0)->nodeValue, 1, 1);
        ...
        $this->Cell(2.6, 0.5, $doc->getElementsByTagName("InscricaoMunicipal")
            ->item(0)->nodeValue, 1);
        ...
        $this->Cell(3, 0.5, $doc->getElementsByTagName("Complemento")
            ->item(0)->nodeValue, 1);
        $this->Cell(2.3, 0.5, "Telefone", 1, 0, "C", 1);
        $this->Cell(2.6, 0.5, $doc->getElementsByTagName("Telefone")
            ->item(0)->nodeValue, 1);
        ...
        $this->Cell(16.8, 0.5, $doc->getElementsByTagName("RazaoSocial")
            ->item(1)->nodeValue, 1, 1);
    ...
    public function printNFSe($arquivo_pdf_destino = '')
    {
        ...
        $this->SetFillColor(230, 230, 230);
        $this->setX(0.5);
        $this->Cell(20, 0.6, $doc->getElementsByTagName("ItemListaServico")
            ->item(0)->nodeValue . " / " . $doc->getElementsByTagName("CodigoTributacaoMunicipio")
            ->item(0)->nodeValue . " - " . $doc->aParser['ServicoPrestado'], 1, 1, 'C', 0);
        ...
        $this->Cell(5, 0.6, $doc->getElementsByTagName("CodigoObra")
            ->item(0)->nodeValue, 1, 0, 'C', 0);
        $this->Cell(5, 0.6, 'Código ART', 1, 0, 'C', 1);
        $this->Cell(5, 0.6, $doc->getElementsByTagName("Art")
            ->item(0)->nodeValue, 1, 1, 'C', 0);
        // FIM OBRAS
        ...
        $this->Cell(2, 0.6, number_format($doc->getElementsByTagName("ValorPis")
            ->item(0)->nodeValue, 2, ",", "."), 1, 0, 'C', 0);
        $this->Cell(2, 0.6, 'COFINS', 1, 0, 'C', 1);
        $this->Cell(2, 0.6, number_format($doc->getElementsByTagName("ValorCofins")
            ->item(0)->nodeValue, 2, ",", "."), 1, 0, 'C', 0);
        $this->Cell(2, 0.6, 'IR (R$)', 1, 0, 'C', 1);
        $this->Cell(2, 0.6, number_format($doc->getElementsByTagName("ValorIr")
            ->item(0)->nodeValue, 2, ",", "."), 1, 0, 'C', 0);
        $this->Cell(2, 0.6, 'INSS (R$)', 1, 0, 'C', 1);
        $this->Cell(2, 0.6, number_format($doc->getElementsByTagName("ValorInss")
            ->item(0)->nodeValue, 2, ",", "."), 1, 0, 'C', 0);
        $this->Cell(2, 0.6, 'CSLL (R$)', 1, 0, 'C', 1);
        $this->Cell(2, 0.6, number_format($doc->getElementsByTagName("ValorCsll")
            ->item(0)->nodeValue, 2, ",", "."), 1, 1, 'C', 0);
        ...
        $this->Cell(3.0, 0.7, number_format($doc->getElementsByTagName("ValorServicos")
            ->item(0)->nodeValue, 2, ",", "."), 1, 0, 'C', 0);
        ...
        $this->Cell(3.0, 0.7, number_format($doc->getElementsByTagName("DescontoIncondicionado")
            ->item(0)->nodeValue, 2, ",", "."), 1, 0, 'C', 0);
        $this->Cell(5.0, 0.7, number_format($doc->getElementsByTagName("NaturezaOperacao")
            ->item(0)->nodeValue, 2, ",", "."), 1, 0, 'C', 0);
        $this->Cell(4.5, 0.7, '(-) Deduções permitidas em lei', 1, 0, 'C', 1);
        $this->Cell(3.0, 0.7, number_format($doc->getElementsByTagName("DescontoCondicionado")
            ->item(0)->nodeValue, 2, ",", "."), 1, 1, 'C', 0); // GABRIEL / HUGO VERIFICAR CONTEUDO
        $this->setX(0.5);
        ...
        $this->Cell(3.0, 0.7, number_format($doc->getElementsByTagName("RetencoesFederais")
            ->item(0)->nodeValue, 2, ",", "."), 1, 0, 'C', 0); //
        $this->Cell(5.0, 0.7, $doc->getElementsByTagName("RegimeEspecialTributacao")
            ->item(0)->nodeValue, 1, 0, 'C', 0);
        $this->Cell(4.5, 0.7, 'Base de Cálculo', 1, 0, 'C', 1);
        $this->Cell(3.0, 0.7, number_format($doc->getElementsByTagName("BaseCalculo")
            ->item(0)->nodeValue, 2, ",", "."), 1, 1, 'C', 0);
        $this->setX(0.5);
        $this->Cell(4.5, 0.7, 'Outras Retenções', 1, 0, 'C', 1);
        $this->Cell(3.0, 0.7, number_format($doc->getElementsByTagName("OutrasRetencoes")
            ->item(0)->nodeValue, 2, ",", "."), 1, 0, 'C', 0);
        $this->Cell(5.0, 0.7, 'Opção Simples Nacional', 1, 0, 'C', 1);
        $this->Cell(4.5, 0.7, '(x) Alíquota %', 1, 0, 'C', 1);
        $this->Cell(3.0, 0.7, number_format($doc->getElementsByTagName("Aliquota")
            ->item(0)->nodeValue, 2, ",", "."), 1, 1, 'C', 0);
        $this->setX(0.5);
        $this->Cell(4.5, 0.7, '(-) ISS Retido', 1, 0, 'C', 1);
        $this->Cell(3.0, 0.7, number_format($doc->getElementsByTagName("IssRetido")
            ->item(0)->nodeValue, 2, ",", "."), 1, 0, 'C', 0);
        ...
        $this->Cell(3.0, 0.7, number_format($doc->getElementsByTagName("ValorIssReter")
            ->item(0)->nodeValue, 2, ",", "."), 1, 1, 'C', 0);
        $this->setX(0.5);
        $this->Cell(4.5, 1, '(=) Valor Líquido   R$', 1, 0, 'C', 1);
        $this->Cell(3.0, 1, number_format($doc->getElementsByTagName("ValorLiquidoNfse")
            ->item(0)->nodeValue, 2, ",", "."), 1, 0, 'C', 0);
        $x = $this->getX();
        $y = $this->getY();
        ...
        $this->Cell(3.0, 1, number_format($doc->getElementsByTagName("ValorIss")
            ->item(0)->nodeValue, 2, ",", "."), 1, 1, 'C', 0);
        $this->setX(0.5);
