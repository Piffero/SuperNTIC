...
class CommonNFePHP
{
     ...
     * @param string $extraTextBefore
     *            prefixo do retorno
     * @param
     *            string extraTextAfter sulfixo do retorno
     * @param
     *            number itemNum numero do item a ser retornado
     * @return string
     */
    ...
    /**
     * __ymd2dmy
     * Converte datas no formato YMD (ex.
     * 2009-11-02) para o formato brasileiro 02/11/2009)
     *
     ...
     * @author Roberto L. Machado <linux.rlm at gmail dot com>
     * @param string $DH
     *            Informação de data e tempo extraida da NFe
     ...
     * Esta função perimite o alinhamento horizontal
     ...
     *            Insere um hiperlink
     * @param boolean $force
     *            Se for true força a caixa com uma unica linha e para isso atera o tamanho do fonte até caber no espaço, se falso mantem o tamanho do fonte e usa quantas linhas forem necessárias
     * @param number $hmax            
