...
class DaEventoNFeNFePHP extends CommonNFePHP implements DocumentoNFePHP
{
     ...
     * @param array $aEnd
     *            array com o endereço do emitente
     * @param number $mododebug
     *            1-SIM e 0-Não (0 default)
     */
    function __construct($docXML = '', $sOrientacao = '', $sPapel = '', $sPathLogo = '', $sDestino = 'I', $sDirPDF = '', $fontePDF = '', $aEnd = '', $mododebug = 0)
    {
        ...
        if (! in_array($this->tpEvento, array(
            '110110',
            '110111'
        ))) {
    ...
    {
        if (1 == 2 || $this->xml == null || $this->infEvento == null) {
            return false;
        }
        return true;
     ...
     *            (Opcional) Estabelece a orientação da impressão (ex. P-retrato), se nada for fornecido será usado o padrão da NFe
     * @param string $papel
