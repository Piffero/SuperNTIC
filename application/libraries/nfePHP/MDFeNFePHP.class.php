...
class MDFeNFePHP
{
     ...
     * @param string $chave
     *            numero da chave da MDFe de 44 digitos
     * @param string $tpAmb
     ...
     *            path completo para o arquivo contendo a MDFe
     ...
     *            Critério de seleção pode ser usados coringas como *-mdfe.xml
