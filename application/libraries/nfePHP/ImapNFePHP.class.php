...
class ImapNFePHP
{
     ...
     *            numero da mensagem
     * @param array $aAtt
     *            array com os dados dos anexos e dos resultados do download
            ...
            for ($iCount = 0; $iCount < count($structure->parts); $iCount ++) {
                ...
                if ($attachments[$iCount]['is_attachment']) {
                    ...
                    if ($structure->parts[$iCount]->encoding == 3) { // 3 = BASE64
                        ...
                        $attachments[$iCount]['attachment'] = quoted_printable_decode($attachments[$iCount]['attachment']);
                    }
                }
            } // fim for
        }
