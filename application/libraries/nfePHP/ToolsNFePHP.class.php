...
class ToolsNFePHP
{
     ...
     *
     * @param array $aConfig
     *            Opcional dados de configuração
     * @param number $mododebug
     *            Opcional 2-Não altera nenhum parâmetro 1-SIM ou 0-NÃO (2 default)
     ...
     * @param array $aError
     *            Variável passada como referencia irá conter as mensagens de erro se houverem
     * @return boolean
     */
     ...
     *            path para o arquivo xml padrão ANFAVEA+GS1 e NT2013_002
     * @param string $tagB2B
     ...
     *            sigla da unidade da Federação
     * @param integer $tpAmb
     *            tipo de ambiente 1-produção e 2-homologação
     * @param
     *            integer 1 usa o __sendSOAP e 2 usa o __sendSOAP2
     * @param array $aRetorno
     *            parametro passado por referencia irá conter a resposta da consulta em um array
     ...
     *            sigla da unidade da federação
     * @param string $IE
     *            opcional numero da inscrição estadual
     * @param string $CNPJ
     *            opcional numero do cnpj
     * @param string $CPF
     *            opcional numero do cpf
     * @param string $tpAmb
     *            tipo de ambiente se não informado será usado o ambiente default
     ...
     * @param string $tpAmb
     *            numero do ambiente 1-producao e 2-homologação
     * @param integer $modSOAP
     *            1 usa __sendSOAP e 2 usa __sendSOAP2
     * @param array $aRetorno
     ...
     *            TRUE - usa ambiente Nacional para buscar a lista de NFe, FALSE usa sua própria SEFAZ
     * @param string $indNFe
     *            Indicador de NF-e consultada: 0=Todas as NF-e; 1=Somente as NF-e que ainda não tiveram manifestação do destinatário (Desconhecimento da operação, Operação não Realizada ou Confirmação da Operação); 2=Idem anterior, incluindo as NF-e que também não tiveram a Ciência da Operação
     * @param string $indEmi
     *            Indicador do Emissor da NF-e: 0=Todos os Emitentes / Remetentes; 1=Somente as NF-e emitidas por emissores / remetentes que não tenham a mesma raiz do CNPJ do destinatário (para excluir as notas fiscais de transferência entre filiais).
     * @param string $ultNSU
     ...
     *            ano com 2 digitos
     * @param string $nSerie
     *            serie da NF 1 até 3 digitos
     * @param integer $nIni
     *            numero inicial 1 até 9 digitos zero a esq
     * @param integer $nFin
     *            numero Final 1 até 9 digitos zero a esq
     * @param string $xJust
     *            justificativa 15 até 255 digitos
     * @param string $tpAmb
     *            Tipo de ambiente 1-produção ou 2 homologação
     * @param integer $modSOAP
     *            1 usa __sendSOAP e 2 usa __sendSOAP2
     ...
     *            Descrição da Correção entre 15 e 1000 caracteres
     * @param string $nSeqEvento
     *            numero sequencial da correção d 1 até 20
     ...
     *            1 usa __sendSOP e 2 usa __sendSOAP2
     * @param mixed $resp
     *            variável passada como referencia e irá conter o retorno da função em um array
     * @return mixed false
     *        
     ...
     *            tag que é assinada
     * @param string $err
     *            variavel passada como referencia onde são retornados os erros
     ...
     * @param string $sUF
     *            Sigla da Unidade da Federação (ex. SP, RS, etc..)
     ...
     *            True testa a validade do certificado ou false não testa
     ...
     * @param array $aRetorno
     *            variavel passa por referência Array com os dados do certificado
     ...
     *            Critério de seleção pode ser usados coringas como *-nfe.xml
     ...
     *            tipo de ambiente 1 - produção e 2 - homologação
     * @param string $UF
     *            unidade da federação, necessário para diferenciar AM, MT e PR
