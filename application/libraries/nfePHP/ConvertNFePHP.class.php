 ...
 * 
 * Esta classe atende aos critÃ©rios estabelecidos no
 * Manual de ImportaÃ§Ã£o/ExportaÃ§Ã£o TXT Notas Fiscais eletrÃ´nicas versÃ£o 2.0.0
 *
 * @package     NFePHP
 * @name        ConvertNFePHP
 * @version     3.1.12
 ...
 *              Eduardo GusmÃ£o <eduardo dot intrasis at gmail dot com>
 ...
 *              JoÃ£o Eduardo Silva CorrÃªa <jscorrea2 at gmail dot com>
...
class ConvertNFePHP
{
    ...
    /**
     * limparString
     * Se for = true remove caracteres especiais na conversÃ£o de TXT pra XML
     *
     * @var boolean
     */
     ...
     *
     * @name contruct
     * @param boolean $limparString
     *            Ativa flag para limpar os caracteres especiais e acentos
     * @return none
     */
     ...
     * MÃ©todo de conversÃ£o das NFe de txt para xml, conforme
     * especificaÃ§Ãµes do Manual de ImportaÃ§Ã£o/ExportaÃ§Ã£o TXT
     * Notas Fiscais eletrÃ´nicas versÃ£o 2.0.0 (24/08/2010)
     *
     * @name nfeTxt2XmlArrayComLinhas
     * @param string $arrayComAsLinhasDoArquivo
     *            Array de Strings onde cada elemento Ã© uma linha do arquivo
     * @return string xml construido
     */
    protected function nfeTxt2XmlArrayComLinhas($arrayComAsLinhasDoArquivo)
    {
        ...
        for ($l = 0; $l < count($arquivo); $l ++) {
            ...
            switch ($dados[0]) {
                case "NOTA FISCAL":
                    ...
                    // primeiro elemento nÃ£o faz nada, aqui Ã© informado o
                    // nÃºmero de NF contidas no TXT
                    break;
                case "A":
                    
                    // atributos da NFe, campos obrigatÃ³rios [NFe]
                    // A|versÃ£o do schema|id
                    // cria nota no array
                    $currnota ++;
                    unset($dom, $NFe, $infNFe, $NFref, $refNFP);
                    // / limpar todas variaveis utilizadas por cada nota fiscal....
                    // (evitar que o produto entre 2 vezes ou q o endereÃ§o anterior seja usado, e coisas do tipo....)
                    unset($dom, $NFe, $infNFe, $ide, $cUF, $cNF, $NatOp, $indPag, $mod, $serie, $nNF, $dEmi, $dSaiEnt, $hSaiEnt, $tpNF, $cMunFG, $tpImp, $tpEmis, $CDV, $tpAmb, $finNFe, $procEmi, $verProc, $dhCont, $xJust, $NFref, $refNFe, $refNF, $AAMM, $CNPJ, $refNFP, $IE, $CPF, $refCTe, $refECF, $nECF, $nCOO, $emit, $xNome, $xFant, $IEST, $IM, $cnae, $CRT, $cnpj, $cpf, $enderEmi, $xLgr, $nro, $xCpl, $xBairro, $cMin, $xMin, $cMun, $xMun, $UF, $CEP, $cPais, $xPais, $fone, $dest, $ISUF, $email, $enderDest, $retirada, $entrega, $det, $infAdProd, $prod, $cProd, $cEAN, $xProd, $NCM, $EXTIPI, $CFOP, $uCom, $qCom, $vUnCom, $vProd, $cEANTrib, $uTrib, $qtrib, $vUnTrib, $vFrete, $vSeg, $vDesc, $vOutro, $indTot, $xPed, $nItemPed, $DI, $dDI, $xLocDesemb, $UFDesemb, $dDesemb, $cExportador, $adi, $nAdicao, $nSeqAdic, $cFabricante, $vDescDI, $veicProd, $tpOP, $chassi, $cCor, $xCor, $pot, $cilin, $pesoL, $pesoB, $nSerie, $tpComb, $nMotor, $CMT, $dist, $anoMod, $anoFab, $tpPint, $tpVeic, $espVeic, $VIN, $condVeic, $cMod, $cCorDENATRAN, $lota, $tpRest, $med, $nLote, $qLote, $dFab, $dVal, $vPMC, $arm, $tpArma, $nCano, $descr, $comb, $cProdANP, $CODIG, $qTemp, $UFCons, $CIDE, $qBCprod, $vAliqProd, $vCIDE, $imposto, $ICMS, $ICMS00, $orig, $CST, $modBC, $vBC, $pICMS, $vICMS, $ICMS10, $modBCST, $pMVAST, $pRedBCST, $vBCST, $pICMSST, $vICMSST, $ICMS20, $pRedBC, $ICMS30, $ICMS40, $motDesICMS, $ICMS51, $ICMS60, $ICMS70, $ICMS90, $ICMSPart, $pBCOp, $UFST, $ICMSST, $vICMSSTRet, $vBCSTRet, $vBCSTDest, $vICMSSTDest, $ICMSSN101, $CSOSN, $pCredSN, $vCredICMSSN, $ICMSSN102, $ICMSSN201, $ICMSSN202, $ICMSSN500, $ICMSSN900, $IPI, $clEnq, $CNPJProd, $cSelo, $qSelo, $cEnq, $IPITrib, $vIPI, $pIPI, $qUnid, $vUnid, $IPINT, $II, $vDespAdu, $vII, $vIOF, $PIS, $PISAliq, $pPIS, $vPIS, $PIDQtde, $qBCProd, $PISNT, $PISOutr, $pPIST, $PISST, $COFINS, $COFINSAliq, $pCOFINS, $vCOFINS, $COFINSQtde, $COFINSNT, $COFINSOutr, $COFINSST, $ISSQN, $vISSQN, $cListServ, $cSitTrib, $total, $ICMSTot, $vST, $vNF, $ISSQNtot, $vServ, $vISS, $retTrib, $vRetPIS, $vRetCOFINS, $vRetCSLL, $vBCIRRF, $vIRRF, $vBCRetPrev, $vRetPrev, $transp, $modFrete, $transportadora, $xEnder, $retTransp, $vBCRet, $pICMSRet, $veicTransp, $placa, $RNTC, $reboque, $vagao, $balsa, $vol, $qVol, $esp, $marca, $nVol, $lacres, $nLacres, $cobr, $fat, $nFat, $vOrig, $vLiq, $dup, $nDup, $dVenc, $vDup, $infAdic, $infAdFisco, $infCpl, $infNFE, $obsCont, $xTexto, $obsFisco, $procRef, $nProc, $exporta, $UFEmbarq, $xLocEmbarq, $compra, $xNEmp, $xCont, $cana, $safra, $qTotMes, $qTotAnt, $qTotGer, $vFor, $vTotDed, $vLiqFor, $forDia, $dia, $qtde, $deduc, $xDed, $vDed, $vTotTrib);
                ...
                case "B14":
                    ...
                    // B14|cUF|AAMM(ano mÃªs)|CNPJ|Mod|serie|nNF|
                    if (! isset($NFref)) {
                        $notas[$currnota]['NFref'] = $dom->createElement("NFref");
                        $NFref = & $notas[$currnota]['NFref'];
                        $ide->insertBefore($ide->appendChild($NFref), $tpImp);
                ...
                case "B20a":
                    ...
                    // Grupo de informaÃ§Ãµes da NF [NFref]
                    if (! isset($NFref)) {
                        $notas[$currnota]['NFref'] = $dom->createElement("NFref");
                        $NFref = & $notas[$currnota]['NFref'];
                        $ide->insertBefore($ide->appendChild($NFref), $tpImp);
                ...
                case "C05":
                    ...
                    // Grupo do EndereÃ§o do emitente [emit]
                ...
                case "E":
                    ...
                    // Grupo de identificaÃ§Ã£o do DestinatÃ¡rio da NF-e [infNFe]
                    // E|xNome|IE|ISUF|email|
                    $dest = $dom->createElement("dest");
                    // se ambiente homologaÃ§Ã£o preencher conforme NT2011.002
                    // vÃ¡lida a partir de 01/05/2011
                    if ($this->tpAmb == '2') {
                ...
                case "E02":
                    ...
                    if ($this->tpAmb == '2') {
                        if ($dados[1] != '') {
                            // operaÃ§Ã£o nacional em ambiente homologaÃ§Ã£o usar 99999999000191
                            $CNPJ = $dom->createElement("CNPJ", '99999999000191');
                        } else {
                            // operaÃ§Ã£o com o exterior CNPJ vazio
                ...
                case "E05":
                    ...
                    // Grupo de endereÃ§o do DestinatÃ¡rio da NF-e [dest]
                ...
                case "F":
                    ...
                    // Grupo de identificaÃ§Ã£o do Local de retirada [infNFe]
                ...
                case "G":
                    ...
                    // Grupo de identificaÃ§Ã£o do Local de entrega [entrega]
                ...
                case "H":
                    ...
                    // Grupo do detalhamento de Produtos e ServiÃ§os da NF-e [infNFe]
                ...
                case "I18":
                    ...
                    // Tag da DeclaraÃ§Ã£o de ImportaÃ§Ã£o [prod]
                ...
                case "J":
                    ...
                    // Grupo do detalhamento de veÃ­culos novos [prod]
                ...
                case "K":
                    ...
                    // Grupo do detalhamento de Medicamentos e de matÃ©riasprimas farmacÃªuticas [prod]
                ...
                case "L101":
                    ...
                    // Grupo de informaÃ§Ãµes especÃ­ficas para combustÃ­veis lÃ­quidos e lubrificantes [prod]
                ...
                case "N06":
                    ...
                    // Grupo de TributaÃ§Ã£o do ICMS 40, 41 ou 50 [ICMS]
                ...
                case "N07":
                    ...
                    // Grupo de TributaÃ§Ã£o do ICMS = 51 [ICMS]
                ...
                case "N08":
                    ...
                    // Grupo de TributaÃ§Ã£o do ICMS = 60 [ICMS]
                ...
                case "N09":
                    ...
                    // Grupo de TributaÃ§Ã£o do ICMS 70 [ICMS]
                ...
                case "N10":
                    ...
                    // Grupo de TributaÃ§Ã£o do ICMS 90 Outros [ICMS]
                ...
                case "N10a":
                    ...
                    // Partilha do ICMS entre a UF de origem e UF de destino ou a UF definida na legislaÃ§Ã£o [ICMS]
                ...
                case "N10b":
                    ...
                    // ICMS ST repasse de ICMS ST retido anteriormente em operaÃ§Ãµes interestaduais com repasses
                    // atravÃ©s do Substituto TributÃ¡rio [ICMS]
                ...
                case "O08":
                    ...
                    // Grupo IPI NÃ£o tributavel 0 ou 1 [IPI]
                    // todos esses campos sao obrigatorios
                ...
                case "P":
                    ...
                    // Grupo do Imposto de ImportaÃ§Ã£o 0 ou 1 [imposto]
                    // todos esses campos sao obrigatorios
                ...
                case "Q02":
                    ...
                    // Grupo de PIS tributado pela alÃ­quota 0 pou 1 [PIS]
                    // todos esses campos sao obrigatorios
                ...
                case "Q04":
                    ...
                    // Grupo de PIS nÃ£o tributado 0 ou 1 [PIS]
                    // todos esses campos sao obrigatorios
                ...
                case "Q05":
                    ...
                    // Grupo de PIS Outras OperaÃ§Ãµes 0 ou 1 [PIS]
                    // Q05|CST|vPIS|
                ...
                case "Q07":
                    ...
                    // Valor da Base de CÃ¡lculo do PIS e AlÃ­quota do PIS (em percentual) 0 pu 1 [PISOutr]
                    // todos esses campos sao obrigatorios
                    // Q07|vBC|pPIS|
                    $vBC = $dom->createElement("vBC", $dados[1]);
                ...
                case "Q10":
                    ...
                    // Quantidade Vendida e AlÃ­quota do PIS (em reais) 0 ou 1 [PISOutr]
                    // todos esses campos sao obrigatorios
                ...
                case "R":
                    ...
                    // Grupo de PIS SubstituiÃ§Ã£o TributÃ¡ria 0 ou 1 [imposto]
                    // todos esses campos sao obrigatorios
                    ...
                    break;
                case "R02": // Valor da Base de CÃ¡lculo do PIS e AlÃ­quota do PIS (em percentual) 0 ou 1 [PISST]
                             // todos esses campos sao obrigatorios
                    $vBC = $dom->createElement("vBC", $dados[1]);
                ...
                case "R04":
                    ...
                    // Quantidade Vendida e AlÃ­quota do PIS (em reais) 0 ou 1 [PISST]
                    // todos esses campos sao obrigatorios
                    $qBCProd = $dom->createElement("qBCProd", $dados[1]);
                ...
                case "S":
                    ...
                    // Grupo do COFINS obrigatÃ³rio [imposto]
                    $COFINS = $dom->createElement("COFINS");
                    $imposto->appendChild($COFINS);
                    break;
                case "S02":
                    
                    // Grupo de COFINS tributado pela alÃ­quota 0 ou 1 [COFINS]
                    // todos esses campos sao obrigatorios
                ...
                case "S04":
                    ...
                    // Grupo de COFINS nÃ£o tributado 0 ou 1 [COFINS]
                    // todos esses campos sao obrigatorios
                ...
                case "S05":
                    ...
                    // Grupo de COFINS Outras OperaÃ§Ãµes 0 ou 1 [COFINS]
                    // S05|CST|vCOFINS|
                ...
                case "S07":
                    ...
                    // Valor da Base de CÃ¡lculo da COFINS e AlÃ­quota da COFINS
                    ...
                    break;
                case "S09": // Quantidade Vendida e AlÃ­quota da COFINS (em reais) 0 ou 1 [COFINSOutr]
                             // todos esses campos sao obrigatorios
                    $qBCProd = $dom->createElement("qBCProd", $dados[1]);
                ...
                case "T":
                    ...
                    // Grupo de COFINS SubstituiÃ§Ã£o TributÃ¡ria 0 ou 1 [imposto]
                    // todos esses campos sao obrigatorios
                ...
                case "T04":
                    ...
                    // Quantidade Vendida e AlÃ­quota da COFINS (em reais) 0 u 1 [COFINSST]
                    // todos esses campos sao obrigatorios
                    $qBCProd = $dom->createElement("qBCProd", $dados[1]);
                ...
                case "W17":
                    ...
                    break;
                case "W23": // Grupo de RetenÃ§Ãµes de Tributos 0 ou 1 [total]
                ...
                case "X":
                    ...
                    // Grupo de InformaÃ§Ãµes do Transporte da NF-e obrigatorio [infNFe]
                    // todos esses campos sÃ£o obrigatÃ³rios
                ...
                case "X11":
                    ...
                    // Grupo de RetenÃ§Ã£o do ICMS do transporte 0 ou 1 [transp]
                    // todos esses campos sÃ£o obrigatÃ³rios
                ...
                case "Y":
                    ...
                    // Grupo de CobranÃ§a 0 ou 1 [infNFe]
                ...
                case "Z":
                    ...
                    // Grupo de InformaÃ§Ãµes Adicionais 0 ou 1 [infNFe]
                ...
                case "ZA":
                    ...
                    // Grupo de ExportaÃ§Ã£o 0 ou 1 [infNFe]
                    // todos os campos sÃ£o obrigatorios
                ...
                case "ZC04":
                    ...
                    // 1 a 31 Grupo de Fornecimento diÃ¡rio de cana [cana]
                    // ZC04|dia|qtde|
                    // todos os campos sÃ£o obrigatorios
                ...
                case "ZC10":
                    ...
                    // 0 a 10 Grupo de DeduÃ§Ãµes Â– Taxas e ContribuiÃ§Ãµes [cana]
                    // ZC10|xDed|vDed|
                    // todos os campos sÃ£o obrigatorios
        ...
        foreach ($notas as $nota) {
            ...
            $this->xml = '';
            // salva o xml na variÃ¡vel se o txt nÃ£o estiver em branco
            if (! empty($infNFe)) {
