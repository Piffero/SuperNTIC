...
if(('webkitSpeechRecognition' in window)){
  ...
  App.speechCommand('go to',{
    ...
    listen: function(datos){
      switch(datos){
        case "dashboard": location.href = "index.php"; break;
        case "cliente": location.href = "customers"; break;
        case "fornecedor": location.href = "supplier"; break;
